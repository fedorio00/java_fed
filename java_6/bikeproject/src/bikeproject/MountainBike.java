...
public class MountainBike extends Bike implements MountainParts {
	...
	public String getSuspension() {
		return this.suspension; // Возвращает текущее значение suspension
	}

	@Override
	public void setSuspension(String newValue) {
		this.suspension = newValue; // Устанавливает новое значение suspension
	}

	@Override
	public String getType() {
		return this.type; // Возвращает текущее значение type
	}

	@Override
	public void setType(String newValue) {
		this.type = newValue; // Устанавливает новое значение type
	}
